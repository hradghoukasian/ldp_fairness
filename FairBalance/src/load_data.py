...
def load(data):
    ...
    datasets = {"adult": load_adult, "heart": load_heart, "compas": load_compas, "bank": load_bank, "default": load_default, "german": load_german, "student-mat": load_student_mat, "student-por": load_student_por}
